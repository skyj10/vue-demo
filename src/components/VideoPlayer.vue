    ...
    <div class="play-content-div">
      <div class="video-play">
        <div class="danmu-player" ref="danmuView" >
          <div ref="danmu" v-for="(item,index) in showDanmuList"  index="index" @transitionend="clearItem(index,$event,item)" :sendStatus="item.sendStatus" class="danmu-play-item">
            <span >{{item.text}}</span>
          </div>
        </div>
      </div>
    ...
    .play-content-div {
      ...
      .video-danmu-send{
        ...
        .danmu-switch{
          ...
          color:#757575 ;transition: all .3s;
          >span{
            position: absolute;
            left: 1px;
            top:1px;
